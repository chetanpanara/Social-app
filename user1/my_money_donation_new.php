            ...
            <form action="">
              <div class="wrapper">
                ...
                <span class="text-center">
                  <!-- <h4 class=" mt-3"> <img src="assets/images/logo.png" alt="Your logo" title="Your logo" style="height:70px;" id="logo"/>Warm Hands</h4> -->
                ...
                <table class="table mt-3">
                  <tr>
                    ...
                    <td><b>RECEIPT No:</b> <?php echo $row->m_id ?></td>
                  </tr>
                  ...
                  <tr>
                    <td><b>Event Title:</b> <?php echo $eventTitle; ?> </td>
                  </tr>
                  <tr>
                    <td><b>Payment ID:</b> <?php echo $row->payment_id; ?> </td>
                  </tr>
                  <tr>
                    <td><b>Donor Name:</b> <?php echo $row->d_name ?></td>
                  </tr>
                  <tr>
                    <td><b>Donation Amount: </b><?php echo $row->amount ?></td>
                  </tr>
