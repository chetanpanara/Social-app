				...
				<div class="tables">
					...
					<div class="panel-body widget-shadow">
						...
						<table class="table">
							...
							<tbody>
								<tr>
								  <th scope="row"><?php echo $row1->user_id;?></th>
								  <th scope="row"><?php echo $row1->name;?></th>
								  <th scope="row"><?php echo $row1->email;?></th>
								  <th scope="row"><?php echo $row1->contact;?></th>
								  <th scope="row"><a href="more_user.php?moreid=<?php echo $row1->user_id;?>">More details..</a></th>
								 </tr>
							</tbody>
							<?php
								}
